  ...
  describe('Association Validations', () => {
    ...
    it('should require an active user_id from the users table', async () => {
      ...
      await expect(
        ...
        `insert or update on table \"liked_pets\" violates foreign key constraint \"liked_pets_user_id_fkey\"`
      );
    });
    it('should require an active pet_id from the pets table', async () => {
      ...
      await expect(
        ...
        `insert or update on table \"liked_pets\" violates foreign key constraint \"liked_pets_pet_id_fkey\"`
      );
    });
  });
});
